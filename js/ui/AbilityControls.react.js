...
function AbilityControls(props: mixed): React.Node {
  ...
  useEffect(() => {
    ...
    abilityLength,
    game.config[queen.playerID].queenAbilities],
  );
  ...
  useEffect(() => {
    ...
    pherLength,
    game.config[queen.playerID].queenPheromones],
  );
  ...
  useEffect(() => {
    ...
    casteLength,
    game.config[queen.playerID].queenLayingCastes],
  );
              ...
              onMouseDown={() => {
                ...
                if (queen.selectedAbility == 'WHIRLWIND') {
                  if (!isActionTypeQueued(queen, 'WHIRLWIND')) {
                    ...
                    dispatchToServer({
                      type: 'ENQUEUE_ENTITY_ACTION', entity: queen, entityAction, time:game.time,
                    });
                  }
                }
              }}
            ...
            {abilityLength <= 1 ? null :
              <Button
                ...
                highlighted={
                  ...
                  highlightedAbility != queen.selectedAbility &&
                  blinkOn
                }
                onClick={() => {
        ...
        >
          ...
          {pherLength <= 1 ? null :
            <Button
              label='> (G)'
              highlighted={
                highlightedPheromone != null &&
                highlightedPheromone != queen.selectedPheromone &&
                blinkOn
              }
              onClick={() => {
      ...
      <div>
        ...
        >
          ...
          <Button
            label='> (B)'
            highlighted={
              highlightedCaste != null &&
              highlightedCaste != queen.selectedCaste &&
              blinkOn
            }
            onClick={() => {
