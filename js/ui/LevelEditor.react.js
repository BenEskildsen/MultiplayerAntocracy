...
const {
  allUpgrades, applyUpgrade,
  argentineanAntUpgrades, marauderAntUpgrades, desertAntUpgrades,
...
function LevelEditor(props: Props): React.Node {
  ...
  const upgradeOptions = useMemo(() => {
    switch (editor.upgradeFilter) {
      case 'ALL':
        return allUpgrades;
      case 'Argentinean': {
        const {initial, additional, triviaBased} = argentineanAntUpgrades();
        const options = {};
      ...
      case 'Leaf Cutter': {
        const {initial, additional, triviaBased} = leafCutterAntUpgrades();
        const options = {};
        for (const up of initial) options[up.name] = up;
        for (const up of additional) options[up.name] = up;
        for (const up of triviaBased) options[up.name] = up;
      ...
      case 'Marauder': {
        const {initial, additional, triviaBased} = marauderAntUpgrades();
        const options = {};
        for (const up of initial) options[up.name] = up;
        for (const up of additional) options[up.name] = up;
        for (const up of triviaBased) options[up.name] = up;
      ...
      case 'Desert': {
        const {initial, additional, triviaBased} = desertAntUpgrades();
        const options = {};
        for (const up of initial) options[up.name] = up;
        for (const up of additional) options[up.name] = up;
        for (const up of triviaBased) options[up.name] = up;
  ...
  useEffect(() => {
    setEditor({...editor, upgrade: Object.keys(upgradeOptions)[0]});
  }, [upgradeOptions]);
  ...
  return (
    ...
    <div>
      <Dropdown
        ...
        onChange={(upgrade) => setEditor({...editor, upgrade})}
      />
      <Button
        label="Apply Upgrade"
        onClick={() => {
          applyUpgrade(
            dispatch, game, editor.playerID,
            allUpgrades[editor.upgrade], !editor.saveUpgrades
          );
    ...
    <div>
      <Checkbox
        ...
        onChange={saveUpgrades => setEditor({...editor, saveUpgrades})}
      />
    </div>
    <div>
      Filter upgrades:
      <Dropdown
        ...
        onChange={(upgradeFilter) => setEditor({...editor, upgradeFilter})}
      />
    </div>
    <div>
      <div>Upgrades Applied:</div>
      {
        state.campaign.upgrades
          .filter(u => u.name != null)
          .map(u => <div>- Player {u.path[0]}: {u.name}</div>)
      }
    </div>
    <div>
      <Button
    ...
    <div>
      ...
      <Dropdown
        ...
        onChange={(selectedSpecies) => setEditor({...editor, selectedSpecies})}
      />
      <Button
        label="Set Species"
        onClick={() => {
          ...
          dispatch({
            type: 'SET_SPECIES', playerID: editor.playerID, species: editor.selectedSpecies,
          });
          setEditor({...editor, cpuSpecies: nextCPUSpecies});
        }}
      />
    </div>
    <Divider />
      ...
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showTruePositions',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showAntDecision',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showHitboxes',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showTrueHitboxes',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showPositionsInFront',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showEntityIDs',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => dispatch({
            type: 'SET', value: shouldShow, property: 'showMarkedFood',
          })}
        />
      </div>
      <div>
        <Checkbox
          ...
          onChange={shouldShow => {
            if (state.game.focusedEntity) {
              dispatch({
                type: 'SET', value: null, property: 'focusedEntity',
              });
            } else {
              dispatch({
                type: 'SET', value: getQueen(game, game.playerID), property: 'focusedEntity',
              });
            }
          }}
        />
  ...
  return (
    <div>
      ...
      <Checkbox
        ...
        onChange={(shouldShow) => dispatch({
          type: 'SET', value: shouldShow, property: 'showPheromoneValues',
        })}
      />
    </div>
  );
    ...
    case 'VINE':
      options.push(<span>
        ...
        <Dropdown
          ...
          onChange={(vineSubType) => setEditor({...editor, vineSubType})}
        />
        <Dropdown
          options={['up', 'down', 'left', 'right']}
          selected={editor.dir}
          onChange={(dir) => setEditor({...editor, dir})}
        />
      </span>);
      break;
    case 'SEED':
      options.push(<span>
        ...
        <Dropdown
          ...
          onChange={(seedType) => setEditor({...editor, seedType})}
        />
      </span>);
      break;
    case 'EGG':
    ...
    case 'DEAD_ANT':
      options.push(<span>
        ...
        <Dropdown
          ...
          onChange={(caste) => setEditor({...editor, caste})}
        />
        <div>
          <Checkbox
            label="Is Goal Critter"
            checked={editor.isGoalCritter}
            onChange={isGoalCritter => setEditor({...editor, isGoalCritter})}
          />
        </div>
      </span>);
      break;
    ...
    case 'DEAD_TERMITE':
      options.push(<span>
        ...
        <Dropdown
          ...
          onChange={(termiteCaste) => setEditor({...editor, termiteCaste})}
        />
        <div>
          <Checkbox
            label="Is Goal Critter"
    ...
    case 'CRITTER_EGG':
      options.push(<span>
        ...
        <Dropdown
          ...
          onChange={(critterEggType) => setEditor({...editor, critterEggType})}
        />
      </span>);
      break;
    case 'WORM':
