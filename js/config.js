...
const config = {
  ...
  audioFiles: [
    ...
    {path: 'audio/Ants-Video-Game Main.mp3', type: 'mp3'},
    {path: 'audio/Beetle Guts.mp3', type: 'mp3'},
    {path: 'audio/Song Oct. 9 (Update).mp3', type: 'mp3'},
    {path: 'audio/Sidewalk Life.mp3', type: 'mp3'},
    {path: 'audio/The Queen, Her Majesty.wav', type: 'wav'},
    {path: 'audio/March of the Ants.wav', type: 'wav'},
    {path: 'audio/Exploration.mp3', type: 'mp3'},
    {path: 'audio/Song Oct. 9.wav', type: 'wav'},
    {path: 'audio/Moving Dirt.wav', type: 'wav'},
    {path: 'audio/Rising suspense song.mp3', type: 'mp3'},
  ],
  campaignAudioFiles: [
    {path: 'audio/campaign/BeetleGuts.mp3', type: 'mp3'},
    {path: 'audio/campaign/Exploration.mp3', type: 'mp3'},
    {path: 'audio/campaign/FairlyConstantSuspense.mp3', type: 'mp3'},
    {path: 'audio/campaign/GatherersRemix.mp3', type: 'mp3'},
    {path: 'audio/campaign/MarchOfTheAnts.mp3', type: 'mp3'},
    {path: 'audio/campaign/QueenAntsGambit.mp3', type: 'mp3'},
    {path: 'audio/campaign/SidewalkLife.mp3', type: 'mp3'},
    {path: 'audio/campaign/SlowSodaCanSongP1.mp3', type: 'mp3'},
    {path: 'audio/campaign/SlowSodaCanSongP2.mp3', type: 'mp3'},
    {path: 'audio/campaign/SpanishAnts.mp3', type: 'mp3'},
    {path: 'audio/campaign/TheQueenHerMajesty.mp3', type: 'mp3'},
  ],
  ...
  entityTypes: [
    'DIRT', 'FOOD', 'STONE',
    'ANT', 'EGG', 'LARVA', 'PUPA',
    'SPIDER', 'SCORPION', 'SPIDER_WEB',
    'BEETLE', 'WORM', 'CENTIPEDE',
    'CATERPILLAR', 'APHID', 'ROLY_POLY',
    'CRITTER_EGG',
    'DEAD_WORM', 'DEAD_CENTIPEDE',
    'DEAD_ANT', 'DEAD_SPIDER', 'DEAD_BEETLE', 'DEAD_TERMITE',
    'DEAD_CATERPILLAR', 'DEAD_APHID', 'DEAD_ROLY_POLY',
    'DEAD_SCORPION',
    'TOKEN', 'DOODAD',
  ...
  critterTypes: [
    'SPIDER', 'SCORPION', 'BEETLE', 'WORM', 'CENTIPEDE',
    'CATERPILLAR', 'APHID', 'ROLY_POLY',
  ],
  unanimatedTypes: [
    'DIRT', 'STONE',
    'DEAD_ANT', 'DEAD_SPIDER',
    'DEAD_ANT', 'DEAD_SPIDER', 'DEAD_BEETLE', 'DEAD_TERMITE',
    'DEAD_WORM', 'DEAD_CENTIPEDE',
    'DEAD_SCORPION',
    // 'DOODAD',
  ...
  tiledTypes: [
    'FOOD', 'DIRT', 'STONE', 'VINE',
  ],

  pheromoneTypes: [
    'COLONY', 'FOOD', 'EGG', 'LARVA', 'PUPA',
    'DIRT_DROP', 'QUEEN_PHER', 'MOVE_LARVA_PHER',
    'CRITTER_PHER', 'MARKED_DIRT_PHER', 'ALERT',
    'QUEEN_ALERT',
    'QUEEN_FOLLOW',
    'QUEEN_DISPERSE',
    'WATER',
  ...
  steadyStatePheromones: [
    'COLONY', 'EGG', 'LARVA', 'PUPA',
    'MARKED_DIRT_PHER', 'MOVE_LARVA_PHER',
    'DIRT_DROP', 'CRITTER_PHER',
    'QUEEN_PHER', 'QUEEN_ALERT', 'ALERT', 'FOOD',
    'QUEEN_FOLLOW',
    'WATER',
    'PATROL_DEFEND_PHER',
    'QUEEN_DISPERSE',
  ...
  dispersingPheromones: [
    ...
    'QUEEN_PHER', 'ALERT', 'FOOD', 'QUEEN_ALERT',
    'WATER',
    'PATROL_DEFEND_PHER',
    'QUEEN_DISPERSE',
    'ACID',
  ...
  pheromoneBlockingTypes: [
    'DIRT', 'FOOD', 'STONE', 'PUPA', 'DOODAD',
    'VINE',
  ],
  waterBlockingTypes: [
    'DIRT', 'FOOD', 'STONE', 'PUPA', 'LARVA',
  ],
  passThroughColonyBlockingTypes: [
    'STONE', 'DOODAD',
  ],
  queenPheromones: [
  ...
  castes: [
    'QUEEN', 'MINIMA', 'MEDIA', 'MAJOR', 'YOUNG_QUEEN',
    'HONEY_POT', 'SUB_MINIMA', 'SOLDIER',
  ],
  tasks: [
    'WANDER', 'EXPLORE', 'RETRIEVE', 'RETURN', 'FEED_LARVA',
    'MOVE_DIRT', 'MOVE_EGG', 'MOVE_LARVA', 'MOVE_PUPA', 'DEFEND',
    'GO_TO_DIRT',
    'QUEEN_WANDER', 'QUEEN_FOLLOW_MOUSE',
    'ATTACK', // handled as a special case
    'PATROL',
    'PATROL_DEFEND',
    'FLY_AWAY',
    'GO_TO_BLOCKAGE',
  ...
  actions: [
    'PICKUP', 'PUTDOWN', 'FEED',
    'MOVE', 'TURN', 'LAY', 'HATCH', 'BITE', 'STING', 'DIE',
    'DASH', 'GRAPPLE',
    'EXAMINE',
    'MOVE_TURN', // combine a move and a turn for better interpolation
    'FALL', 'STOMP', 'LIFT', // FOOT actions
    'BURROW_HOME',
  ],
  ...
  // CPU
  attackTiming: 0, // no attack by default
  maxLarva: 12,
  ...
  castePickup: [
    'SUB_MINIMA', 'MINIMA', 'MEDIA', 'QUEEN',
    'SOLDIER',
    'TERMITE_WORKER',
  ],
  // TODO: pickupTypes should just live on the caste
  antPickupTypes: [
    'FOOD', 'DIRT', 'EGG', 'LARVA', 'PUPA', 'TERMITE_EGG', 'SEED',
    'CRITTER_EGG',
  ],
  queenPickupTypes: [
    'TOKEN', 'FOOD', 'DIRT', 'EGG', 'LARVA', 'PUPA', 'TERMITE_EGG', 'SEED',
    'CRITTER_EGG',
  ],
  warriorQueenBlockingTypes: [
    'DIRT', 'TOKEN',
    'STONE', 'DOODAD', // 'FOOD',
  ],
  ...
  QUEEN: {
    ...
    blockingTypes: [
      'ANT',
      'FOOD', 'DIRT', 'TOKEN', 'SPIDER', 'SCORPION', 'BEETLE',
      'STONE', 'DOODAD', // 'BACKGROUND',
      'PUPA',
      'TERMITE',
      'WORM', 'CENTIPEDE',
      'CATERPILLAR', 'APHID', 'ROLY_POLY',
  ...
  YOUNG_QUEEN: {
    ...
    maxHold: 0,
    blockingTypes: [
      'FOOD', 'TOKEN', 'SPIDER', 'SCORPION', 'BEETLE',
      'ANT',
      'STONE', 'DOODAD', // 'BACKGROUND',
      'TERMITE',
      'WORM', 'CENTIPEDE',
  ...
  ANT: {
    ...
    blockingTypes: [
      'FOOD', 'DIRT', 'ANT', 'SPIDER', 'SCORPION', 'BEETLE',
      'STONE', 'DOODAD', // 'BACKGROUND',
      'PUPA',
      'TERMITE',
      'WORM', 'CENTIPEDE',
    ...
    blockingTypes: [
      'FOOD', 'ANT', 'SPIDER', 'SCORPION', 'BEETLE',
      'STONE', 'DOODAD', // 'BACKGROUND',
      'PUPA',
      'TERMITE',
      'CENTIPEDE',
  ...
  VINE: {
    ...
    foodWidth: 4,
    foodHeight: 4,
    growthRate: 1400 * 3, // 40 ticks
    forkedGrowthRate: 3000 * 3, // ticks if you've grown already
    hp: 20,
    forkRate: 0.15,
    leafRate: 0.0075,
    foodRate: 0.75,
    seedRate: 0.05, // likelihood of getting a seed when a vine dies
    foodRateOnDeath: 0.2, // likelihood of getting a food when a vine dies
    waterMultiplier: 12, // how much faster you grow with water
    domesticateMultiplier: 12, // how much faster you grow w/domesticate pheromone
    blockingTypes: [
      'FOOD', 'DIRT', 'ANT', 'SPIDER', 'SCORPION', 'BEETLE',
      'STONE', 'DOODAD', // 'BACKGROUND',
      'PUPA',
  ...
  QUEEN_ALERT: {
    quantity: 120,
    decayAmount: 10,
    decayRate: 0.25, // how much it decays per tick
    color: 'rgb(255, 0, 0)',
    tileIndex: 2,
  },
  QUEEN_FOLLOW: {
  ...
  WATER: {
    ...
    decayAmount: 4,
    //decayRate: 0,
    decayRate: 0.0005, // how much it decays per tick
    color: 'rgb(0, 0, 255)',
    tileIndex: 1,
  },
  ACID: {
    quantity: 10,
    decayAmount: 3,
    decayRate: 0.05, // how much it decays per tick
    color: 'rgb(0, 0, 255)',
    tileIndex: 3,
  },
  PATROL_DEFEND_PHER: {
    quantity: 100,
    decayAmount: 10,
    decayRate: 0.125, // how much it decays per tick
    color: 'rgb(0, 0, 255)',
    tileIndex: 3,
  },
  QUEEN_DISPERSE: {
  ...
  ATTACK: { // NOTE: is actually handled based on the opposing playerID
    base: 1,
    forwardMovementBonus: 40,
    ALERT: 1000,
    QUEEN_ALERT: 1000,
  ...
  GO_TO_BLOCKAGE: { // NOTE: is actually handled based on the opposing playerID
    base: 1,
    forwardMovementBonus: 5,
    PASS_THROUGH_COLONY: 100,
  },
