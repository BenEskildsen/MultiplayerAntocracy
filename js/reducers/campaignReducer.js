...
const campaignReducer = (campaign: Campaign, action: Action): Campaign => {
  ...
  switch (action.type) {
    ...
    case 'CLEAR_UPGRADES': {
      ...
      return {
        isCampaign: true, // whether or not we're actually in the campaign
...
module.exports = {campaignReducer};
