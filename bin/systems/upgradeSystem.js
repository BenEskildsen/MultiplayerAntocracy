...
const initUpgradeSystem = store => {
  ...
  store.subscribe(() => {
    ...
    if (numYoungQueens >= targetNum && !game.upgradedYoungQueens) {
      ...
      dispatch({
        type: 'SET_MODAL',
        modal: /*#__PURE__*/React.createElement(CampaignUpgradeModal, {
          store: store,
    ...
    if (isNeighboringTrivia && !game.triviaLocated) {
      ...
      dispatch({
        ...
        modal: /*#__PURE__*/React.createElement(SmantModal, {
          ...
          body: /*#__PURE__*/React.createElement("span", null, /*#__PURE__*/React.createElement("div", null, upgrade.trivia), /*#__PURE__*/React.createElement(Divider, null), /*#__PURE__*/React.createElement("div", {
            style: {
              textAlign: "center"
            }
          }, "Adaptation Provided: ", /*#__PURE__*/React.createElement("b", null, upgrade.name)), /*#__PURE__*/React.createElement("div", null, upgrade.description)),
          buttons: [{
            label: 'Adapt',
            onClick: () => {
              dispatch({
...
const freePlayUpgrades = (store, dispatch, state) => {
  ...
  if (shouldUpgrade) {
    ...
    dispatch({
      type: 'APPEND_UPGRADED_AT',
      upgradeNum
    });
    dispatch({
      type: 'SET_MODAL',
      modal: /*#__PURE__*/React.createElement(UpgradeModal, {
        store: store,
        dispatch: store.dispatch,
        state: state
      })
...
function getIsQueenNearTrivia(game, queen) {
  ...
  for (const pos of positions) {
    const triviaEntities = lookupInGrid(game.grid, pos).map(id => game.entities[id]).filter(e => e.type == 'DOODAD' && e.sprite == 'QUESTION');
