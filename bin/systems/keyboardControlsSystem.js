...
const initKeyboardControlsSystem = store => {
  ...
  document.onkeydown = ev => {
    ...
    if (dir != null) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: dir, pressed: true, time});
      return;
    }
    if (ev.keyCode === 13) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: 'enter', pressed: true, time});
      return;
    }
    if (ev.keyCode === 32) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: 'space', pressed: true, time});
      return;
    }
    ...
    if (character != null) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: character, pressed: true, time});
    }
  };
  ...
  document.onkeyup = ev => {
    ...
    if (dir != null) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: dir, pressed: false, time});
      return;
    }
    if (ev.keyCode === 13) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: 'enter', pressed: false, time});
      return;
    }
    if (ev.keyCode === 32) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: 'space', pressed: false, time});
      return;
    }
    const character = String.fromCharCode(ev.keyCode).toUpperCase();
    if (character != null) {
      ...
      // dispatchToServer({type: 'SET_KEY_PRESS', key: character, pressed: false, time});
    }
  };
};
...
const getUpDownLeftRight = ev => {
  ...
  if (keyCode === 68 || keyCode === 39 || keyCode === 100) {
    // HACK: apostrophe is also 39 but they're different for keypress vs keyup/down
