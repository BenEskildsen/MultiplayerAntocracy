    ...
    case 'START':
      {
        ...
        const game = initBaseState({
          x: 25,
          y: 25
        }, 2, [((_state = state) === null || _state === void 0 ? void 0 : (_state$campaign = _state.campaign) === null || _state$campaign === void 0 ? void 0 : _state$campaign.species) || 'Marauder Ants', 'Leaf Cutter Ants'], state.clientID, getSession(state).clients);
    ...
    case 'SET_LEVEL':
      {
        ...
        const game = initBaseState({
          x: gridWidth,
          y: gridHeight
        }, numPlayers, [((_state6 = state) === null || _state6 === void 0 ? void 0 : (_state6$campaign = _state6.campaign) === null || _state6$campaign === void 0 ? void 0 : _state6$campaign.species) || 'Marauder Ants', ...(cpuSpecies || ['Leaf Cutter Ants'])], state.clientID, getSession(state).clients);
    ...
    case 'SET_PLAYERS_AND_SIZE':
      {
        ...
        if (action.numPlayers != null || level.reset) {
          ...
          const game = initBaseState({
            x: gridWidth,
            y: gridHeight
          }, numPlayers, [((_state7 = state) === null || _state7 === void 0 ? void 0 : (_state7$campaign = _state7.campaign) === null || _state7$campaign === void 0 ? void 0 : _state7$campaign.species) || 'Marauder Ants', ...(cpuSpecies || ['Leaf Cutter Ants'])], state.clientID, getSession(state).clients);
